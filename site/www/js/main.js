...
function mainResponsive(){
	...
	if(navigator.appVersion.indexOf("MSIE 7.")==-1 && navigator.appVersion.indexOf("MSIE 8.")==-1) {
		...
		var $visualRatio = parseFloat(313 / 990).toFixed(3);
		var $visualHeight = Math.round($width * $visualRatio);
		$(".visual, .visual .visual_list").height($visualHeight);
	}
}

function mainOrg(){
	$(".visual, .visual .visual_list").height("");
}
...
$(function() {
	...
	var $newsSize = $newsList.find('li').length;
