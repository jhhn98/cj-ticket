...
<head>
	...
	<meta title="${bbs.bbsNm} 목록" />
	<title>${bbs.bbsNm} 목록</title>
		...
		<fieldset>
			...
			<div class="card card--bgcolor p-search">
				<div class="p-form-group">
					...
					<input type="text" name="searchKrwd" id="searchKrwd" class="p-input p-input--beside" title="검색단어 입력" value="@@{bbsNttVO.searchKrwd}" placeholder="검색단어 입력">
					...
					<c:otherwise>
						...
						<td ${tdClass}>
							<#if  (bbsInfo.nttLinkTrgetField!"")?string = bbsFieldListShow.fieldCode>
								<a href="<c:out value="@@{nttUrl}"/>" target="${bbsInfo.nttLinkTrget}">
							</#if>
	...
	<div class="p-pagination">
		<div class="p-page">
			<c:url var="paginationUrl" value="./selectBbsNttList.do">
				...
				<c:param name="searchKrwd" value="@@{bbsNttVO.searchKrwd}" />
				<c:param name="integrDeptCode" value="@@{bbsNttVO.integrDeptCode}"/>
				<c:param name="pageIndex" value="@@{bbsNttVO.pageUnit}"/>
