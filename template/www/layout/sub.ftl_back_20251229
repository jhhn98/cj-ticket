...
<div class="programModal" data-modal-layer="modal3">
    ...
    <div class="modalBody2">
        ...
        <table class="table modalTable">
            ...
            <tr>
                <th scope="row"><div class="innerCell"><label for="bank">은행명<span class="point-color-red">*</span></label></div></th>
                <td>
                    <div class="innerCell">
                        <input type="text" name="rfndBankNm" id="bank" class="customInputDefault">
                    </div>
                </td>
            </tr>
            <tr>
                <th scope="row"><div class="innerCell"><label for="bankNum">계좌번호<span class="point-color-red">*</span></label></div></th>
                <td>
                    <div class="innerCell">
                        <input type="text" name="rfndAcctNo" id="bankNum" class="customInputDefault">
                    </div>
                </td>
            </tr>
            <tr>
                <th scope="row"><div class="innerCell"><label for="name">예금주<span class="point-color-red">*</span></label></div></th>
                <td>
                    <div class="innerCell">
                        <input type="text" name="rfndDpstrNm" id="name" class="customInputDefault">
                    </div>
                </td>
            </tr>
            <tr>
                <th scope="row"><div class="innerCell"><label for="reason">취소사유<span class="point-color-red">*</span></label></div></th>
                <td>
                    <div class="innerCell">
                        <input type="text" name="rfndReason" id="reason" class="customInputDefault">
                    </div>
                </td>
            </tr>
            </tbody>
