...
<div class="contents">
    ...
    <form:form modelAttribute="cmmnAtchInfoVO" name="cmmnAtchInfoVO" action="cmmnAtchInfoUpdt.do" onsubmit="return validateCmmnAtchInfoVO(this)">
            ...
            <tr>
                ...
                <td>
                    <div class="form_element">
                        <span class="element_wrap"><form:input path="infoCode"/></span>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="form_element">
                        <span class="element_wrap"><form:input path="infoNm"/></span>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="form_element">
                        <span class="element_wrap"><form:input path="infoDc"/></span>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="form_element">
                        <span class="element_wrap">${realPath} <form:input path="storePath" /></span>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="form_element">
                        <span class="element_wrap"><form:input path="fileMaxSize"/></span>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="form_element">
                        <span class="element_wrap"><form:input path="fileMaxCo"/></span>
                    </div>
                </td>
            </tr>
            <tr>
