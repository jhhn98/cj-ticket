...
<div class="page_location">
	...
	<i class="sign_gt">메뉴 위치 구분 기호 ></i>
	<span class="depth4_title"><c:out value="${cmmnCodeVO.codeIdNm}"/>(<span class="em_red"><c:out value="${cmmnCodeVO.codeId}"/></span>) 수정</span>
</div>
...
<div class="dataWrap">
    ...
    <form:form modelAttribute="cmmnCodeVO" name="cmmnCodeForm" action="updateCmmnCode.do" onsubmit="return validateCmmnCodeVO(this)">
