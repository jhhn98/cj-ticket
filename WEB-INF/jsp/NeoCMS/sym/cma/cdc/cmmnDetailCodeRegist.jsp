...
<div class="dataWrap">
    <form:form modelAttribute="cmmnDetailCodeVO" name="cmmnDetailCodeForm" action="addCmmnDetailCode.do" onsubmit="return validateCmmnDetailCodeVO(this)">
        ...
        <table>
            ...
            <tbody>
            <tr>
                <th scope="row" class="essential_input"><form:label path="code">코드</form:label></th>
                <td>
                    <div class="form_element">
                        <span class="element_wrap"><form:input path="code" maxlength="15"/><form:errors path="code"/></span>
                    </div>
                </td>
            </tr>
            <tr>
