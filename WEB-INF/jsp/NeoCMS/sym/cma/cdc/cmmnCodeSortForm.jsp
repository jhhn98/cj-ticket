...
<html lang="ko">
<head>
<title>${cmmnCode.codeIdNm} - 하위 코드 순서변경</title>
<meta name="decorator" content="neo" />
<link rel="stylesheet" href="./css/subheader.css" />
<script nonce="NEOCMSSCRIPT">
    function index_up() {
        var form = document.getElementById('cmmnCode');
...
<div class="page_location">
    ...
    <i class="sign_gt">메뉴 위치 구분 기호 ></i>
    <span class="depth5_title">하위코드 순서변경</span>
</div>
...
<div class="contents">
    <form:form modelAttribute="cmmnCode" name="menuForm" action="updateCmmnCodeSort.do" onsubmit="return IdxSubmit(this)" method="post">
        ...
        <select name="idx" style="height:260px; width:100%; border:solid 1px #528ED8" size="16">
            <c:forEach var="codeList" items="${resultList}" varStatus="status">
