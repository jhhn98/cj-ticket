...
<c:set var="active_menu" value="LOG_2" scope="request"/>
...
<div class="tab_navigation">
    <a href="/neo/selectConectLogOsMnbyList.do?siteId=<c:out value="${siteInfo.siteId}"/>" >월별 접속로그</a></li>
    <a href="/neo/selectConectLogOsYnbyList.do?siteId=<c:out value="${siteInfo.siteId}"/>" class="current">년별 접속로그</a></li>
</div>
    ...
    <div class="arrangementWrap data_info">
        ...
        <div class="arrRight">
            <div class="table_search">
                <form name="conectLog" id="conectLog" method="post" action="./selectConectLogOsYnbyList.do">
