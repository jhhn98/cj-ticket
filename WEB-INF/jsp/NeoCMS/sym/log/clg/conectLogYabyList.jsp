...
<div class="tab_navigation">
	...
	<a href="/neo/selectConectLogMnbyList.do?siteId=<c:out value="${siteInfo.siteId}"/>" >월별 접속로그</a></li>
	<a href="/neo/selectConectLogYabyList.do?siteId=<c:out value="${siteInfo.siteId}"/>" class="current">년별 접속로그</a></li>
</div>
