...
<c:set var="active_menu" value="LOG_3" scope="request"/>
...
<div class="tab_navigation">
	<a href="/neo/selectConectLogBrwsrMnbyList.do?siteId=<c:out value="${siteInfo.siteId}"/>" class="current">월별 접속로그</a></li>
	<a href="/neo/selectConectLogBrwsrYnbyList.do?siteId=<c:out value="${siteInfo.siteId}"/>" >년별 접속로그</a></li>
</div>
	...
	<div class="arrangementWrap data_info">
		...
		<div class="arrRight">
			<div class="table_search">
				<form name="conectLog" id="conectLog" method="post" action="./selectConectLogBrwsrMnbyList.do">
