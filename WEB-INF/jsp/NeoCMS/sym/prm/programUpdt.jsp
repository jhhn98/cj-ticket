...
<div class="page_location">
	...
	<span class="depth2_title"><c:out value="${program.progrmNm}"/> 수정</span>
</div>
<div class="dataWrap">
    <form:form modelAttribute="programVO" name="programForm" action="updateProgram.do" onsubmit="return validateProgramVO(this)">
        ...
        <table>
                ...
                <td>
                    <div class="form_element">
                        <span class="element_wrap">
                            <form:input path="progrmNm" size="40"/>
            ...
            <tr>
                ...
                <td>
                    <div class="form_element">
                        <span class="element_wrap">
                            <form:input path="manageUrl" size="60"/>
                            <form:errors path="manageUrl"/>
                        </span>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="form_element">
                        <span class="element_wrap">
                            <form:input path="progrmDc" size="80"/>
            ...
            <tr>
                ...
                <td>
                    <div class="form_element">
                        <span class="element_wrap">
                            <form:input path="progrmCode" size="80" maxlength="10"/>
                            <form:errors path="progrmCode"/>
                        </span>
                    </div>
                </td>
            </tr>
