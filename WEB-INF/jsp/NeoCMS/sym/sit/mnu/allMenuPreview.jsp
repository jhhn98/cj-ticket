...
<div class="contents ">
	...
	<div class="p-progress p-progress--ellipse">
		<ol class="p-progress__list item3">
			...
			<li class="p-progress__item active"><span class="p-progress__link">2. 메뉴 미리보기</span></li>
			<li class="p-progress__item "><span class="p-progress__link">3. 등록완료</span></li>
		</ol>
	</div>
	...
	<div class="arrangementWrap data_button">
		...
		<div class="arrRight">
			<form id="frmSubmit" name="frmSubmit" action="/neo/addAllMenu.do">
				<input type="hidden" name="siteId" id="siteId" value="${siteId}">
				<button type="submit" class="iconTextButton write"><span>메뉴 저장하기</span></button>
			</form>
		</div>
	</div>
</div>
