...
<div class="dataWrap">
    <form:form modelAttribute="template" name="templateForm" action="updateTemplate.do" enctype="multipart/form-data" onsubmit="return validateTemplate(this)">
    <div class="form_wrap is_bottom_wrap">
