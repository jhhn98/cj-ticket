...
<div class="dataWrap">
<form:form modelAttribute="popupItemVO" name="popupItemVOForm" action="addPopupItem.do" onsubmit="return validatePopupItemVO(this)" enctype="multipart/form-data">
	...
	<table>
		...
		<tr>
			<th><em>*</em> <form:label path="linkTrget">링크대상</form:label></th>
			<td>
		...
		<tr>
			<th><em>*</em> <label for="imageFile">이미지파일</label></th>
	...
	<div class="arrangementWrap marginTop_20">
		<div class="arrLeft">
			<a href="./selectPopupItemList.do?siteId=${popupItemVO.siteId}&amp;pageUnit=${popupItemVO.pageUnit}&amp;searchCnd=${popupItemVO.searchCnd}&amp;searchKrwd=${popupItemVO.searchKrwd}&amp;searchShowSe=${popupItemVO.searchShowSe}&amp;pageIndex=${popupItemVO.pageIndex}"  class="iconTextButton list"><span>목록</span></a>
		</div>
		<div class="arrRight">
