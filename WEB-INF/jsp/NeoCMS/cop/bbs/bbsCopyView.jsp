...
<div class="page_location">
    ...
    <i class="sign_gt">메뉴 위치 구분 기호 ></i>
    <span class="depth4_title">복제</span>
</div>
<div class="dataWrap">
    <form:form modelAttribute="bbsVO" name="bbsVOForm" action="copyBbs.do" onsubmit="return validateBbsVO(this)">
        ...
        <table>
            ...
            <tr>
                <th scope="row">사이트</th>
                <td><c:out value="${siteInfo.siteNm}"/></td>
            </tr>
            <tr>
