...
<div class="p-wrap">
    ...
    <div class="col-20">
        ...
        <form:form modelAttribute="bannerZoneItemVO" name="bannerZoneItemVOForm" action="updateBannerZoneItem.do" onsubmit="return validateBannerZoneItemVO(this)" enctype="multipart/form-data">
            <input type="hidden" name="key" id="key2" value="<c:out value="${key}"/>" />
            <form:hidden path="siteId"/>
            <form:hidden path="bannerZoneNo"/>
            <form:hidden path="bannerZoneIemNo"/>
            ...
            <table class="p-table" id="burialTable">
                ...
                <tr>
                    <th scope="row"><form:label path="linkTrget">링크대상</form:label><span class="p-form__required--icon">필수</span></th>
                    <td>
                        <div class="form_element">
                        <span class="element_wrap">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <span class="element_wrap el_textarea">
                            <form:textarea path="imageReplcText" style="width:500px; height:100px" class="p-input" /><form:errors path="imageReplcText"/>
                        </span>
                        </div>
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="imageFile">이미지파일</label><span class="p-form__required--icon">필수</span></th>
                    <td>
                        <div class="form_element">
                        <span class="element_wrap">
