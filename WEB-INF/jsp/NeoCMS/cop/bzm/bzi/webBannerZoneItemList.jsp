...
<c:forEach var="result" items="${bannerZoneItemList}" varStatus="status">
    ...
    <div class="p-wrap bbs bbs__list">
        <div class="p-pagination">
            <div class="p-page">
        	<ui:pagination paginationInfo="${tsu:xssPagingFilter(paginationInfo)}" type="board" jsFunction="./selectBannerZoneItemWebList.do?key=${tsu:xssLinkFilter(key)}&amp;bannerZoneNo=${tsu:xssLinkFilter(bannerZoneItemVO.bannerZoneNo)}&amp;pageUnit=${tsu:xssLinkFilter(bannerZoneItemVO.pageUnit)}&amp;searchCnd=${tsu:xssLinkFilter(bannerZoneItemVO.searchCnd)}&amp;searchKrwd=${tsu:xssLinkFilter(bannerZoneItemVO.searchKrwd)}&amp;pageIndex=" />
            </div>
        </div>
    </div>
