...
<div class="dataWrap">
    <form:form modelAttribute="popupZone" name="popupZoneForm" action="addPopupZone.do" onsubmit="return validatePopupZone(this)">
        <table class="settingFormTable">
            ...
            <tbody>
            <tr>
                <th scope="row" class="essential_input verticalAMiddle"><form:label path="siteId">사이트ID</form:label></th>
                <td>
                                ...
                                <optgroup label="<c:out value="${siteSeList.codeNm}"/>">
                                    <c:forEach var="siteInfoList" items="${siteInfoList}" varStatus="status">
                                        <c:if test="${siteSeList.code eq siteInfoList.siteSe}">
                                            <option value="<c:out value="${siteInfoList.siteId}"/>" <c:if test="${popupZone.siteId eq siteInfoList.siteId}">selected="selected"</c:if>><c:out value="${siteInfoList.siteNm}"/></option>
                                        </c:if>
                                    </c:forEach>
                                </optgroup>
                            </c:forEach>
