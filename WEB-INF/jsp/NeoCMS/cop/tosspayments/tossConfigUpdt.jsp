...
<div class="p-wrap">
    ...
    <form:form modelAttribute="tossConfig" name="tossConfig" method="post" action="updateTossConfig.do" onsubmit="return fn_updateTossConfigCheck(this)">
        <fieldset>
            <legend>토스페이먼츠 설정 수정</legend>
            <input type="hidden" name="key" value="<c:out value="${key}"/>"/>
            <input type="hidden" name="tossConfigNo" value="<c:out value="${tossConfig.tossConfigNo}"/>"/>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form:select path="insttNo" class="p-input p-input--auto">
                            ...
                            <c:if test="${empty tossConfig.prgSe}">
...
<script>
    ...
    function fn_updateTossConfigCheck(form){
