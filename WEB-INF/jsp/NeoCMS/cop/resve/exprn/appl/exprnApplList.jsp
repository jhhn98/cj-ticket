...
<head>
    ...
    <title>${menuInfo.cntntsNm} > 신청 목록</title>
</head>
<body>
                ...
                <div class="col-4">
                    <div class="p-date-group">
                        <div class="p-form-group p-date" data-date="datepicker">
                            <input type="text" name="searchBgnDeFmt" id="searchBgnDeFmt" value="<c:out value="${exprnApplSearchVO.searchBgnDeFmt}"/>" class="p-input" placeholder="yyyy-mm-dd"<c:if test="${exprnApplSearchVO.searchCnd == 'all'}"> disabled</c:if>/>
                        ...
                        <div class="p-form-group p-date" data-date="datepicker">
                            <input type="text" name="searchEndDeFmt" id="searchEndDeFmt" class="p-input" value="<c:out value="${exprnApplSearchVO.searchEndDeFmt}"/>" placeholder="yyyy-mm-dd"<c:if test="${exprnApplSearchVO.searchCnd == 'all'}"> disabled</c:if>/>
                            <div class="p-input__split">
                                <button type="button" class="p-input__item  p-date__icon">달력 열기</button>
                            </div>
                        </div>
    ...
    <table class="p-table p-table--bordered">
        ...
        <c:forEach var="result" items="${exprnApplList}">
            <tr>
                ...
                <td><a href="./updateExprnApplView.do?exprnApplNo=<c:out value="${result.exprnApplNo}"/>&amp;<c:out value="${exprnApplSearchVO.params}"/><c:out value="${exprnApplSearchVO.paramsMng}"/><c:out value="${exprnSearchVO.exprnParamsMng}"/>" class="p-button p-button--small edit">수정</a></td>
            </tr>
    ...
    <div class="row margin_b_30">
        ...
        <div class="col-10 center">
            <div class="p-pagination">
                <div class="p-page">
                    <ui:pagination paginationInfo="${paginationInfo}" type="board" jsFunction="./selectExprnApplList.do?${exprnApplSearchVO.paramsExclPi}${exprnApplSearchVO.paramsMng}&amp;pageIndex=" />
                </div>
            </div>
        </div>
