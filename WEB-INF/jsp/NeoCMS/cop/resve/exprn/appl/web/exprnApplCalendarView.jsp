...
<form method="post" name="exprnApplVO" action="./addExprnApplWebView.do" onsubmit="return fn_addExprnApplCheck(this);">
    <input type="hidden" name="key" value="<c:out value="${key}"/>" />
    <input type="hidden" name="exprnNo" value="<c:out value="${exprnVO.exprnNo}"/>" />
    <input type="hidden" name="exprnDe" value="" />
    ...
    <fieldset>
        ...
        <ul class="ul">
            ...
            <c:if test="${exprnVO.mtLmttTime > 0}">
                <li><span class="point-color-red">월별 신청가능 시간은 최대 <c:out value="${exprnVO.mtLmttTime}"/>시간</span> 입니다.</li>
            </c:if>
        </ul>
            ...
            <div class="selectConfirm" style="display: none;">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <p><em class="amount" data-exprn-amt="<c:out value="${exprnVO.exprnAmt}"/>">0</em>원</p>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="agreeBox">
                    ...
                    <div class="agreeExplanation">
                        <div class="agreeInnerBox">
                            ...
                            <ul>
                                <li>1. 제공받는자: 원주시 산하 실과&middot;사업소, 동주민센터</li>
...
<script>
    ...
    $(document).on("change", "input[name=exprnSchdNo]", function () {

        var $exprnSchdNoCheckd = $("input[name='exprnSchdNo']:checked");
        ...
        if ($exprnSchdNoCheckd.length > 0) {

            $("input[name='exprnSchdNo']").not(this).prop("checked", false);

            totalTimeVal += $(this).data('tmInterval');
            amountVal = $amount.data('exprnAmt');
    ...
    function fn_addExprnApplCheck(form){
        ...
        if ($('input[name=exprnSchdNo]:checked').length < 1) {
