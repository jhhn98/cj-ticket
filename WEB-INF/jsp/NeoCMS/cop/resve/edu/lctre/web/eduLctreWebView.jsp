                            ...
                            <tr>
                                ...
                                <td>
                                    <c:if test="${not empty eduLctreVO.addRcptBgnDt}">
                                        <c:out value="${tsu:toDateFormat(eduLctreVO.addRcptBgnDt,'yyyyMMddHHmm','yyyy-MM-dd HH:mm')}"/>
                                    </c:if>
                                    ~
                                    <c:if test="${not empty eduLctreVO.addRcptEndDt}">
                                        <c:out value="${tsu:toDateFormat(eduLctreVO.addRcptEndDt,'yyyyMMddHHmm','yyyy-MM-dd HH:mm')}"/>
                                    </c:if>
                                </td>
                            </tr>
                        </c:if>
