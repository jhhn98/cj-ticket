...
<div class="p-wrap">
        ...
        <form:form modelAttribute="placeVO" name="placeVO" method="post" action="updatePlace.do" onsubmit="return fn_updatePlaceCheck(this)">
            <fieldset>
                <legend>장소 수정</legend>
                <form:hidden path="placeNo"/>
...
<script>
    ...
    function fn_updatePlaceCheck(form){
