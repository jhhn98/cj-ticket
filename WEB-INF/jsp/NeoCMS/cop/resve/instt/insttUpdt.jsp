...
<div class="p-wrap">
        ...
        <form:form modelAttribute="insttVO" name="insttVO" method="post" action="updateInstt.do" onsubmit="return fn_updateInsttCheck(this)">
            <fieldset>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="p-form-checkbox">
                                <input type="radio" name="useYn" id="useYn1" class="p-form-radio__input" value="Y"<c:if test="${insttVO.useYn == 'Y'}"> checked</c:if> />
                                <label for="useYn1" class="p-form-radio__label">운영</label>
                            </span>
                                <span class="p-form-checkbox">
                                <input type="radio" name="useYn" id="useYn2" class="p-form-radio__input" value="N"<c:if test="${insttVO.useYn == 'N'}"> checked</c:if> />
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("input[name=insttNm]").on("change", function() {
            if (originVal != $("input[name=insttNm]").val()) {
                ...
                $("input[name=insttNmCheckAt]").val("Y");
            }
        });
    })
    ...
    function fn_insttNmCheck() {
        ...
        var insttNo = $("input[name=insttNo]");
        var insttNm = $("input[name=insttNm]");
        var insttNoVal = insttNo.val();
    ...
    function fn_updateInsttCheck(form){
