...
<head>
    ...
    <title><c:out value="${menuInfo.naviList[0].menuNm}"/> &gt; ${menuInfo.cntntsNm} 등록</title>
</head>
<body>
...
<div class="p-wrap">
    ...
    <div class="row">
        ...
        <em class="em_b_red">시설예약 정보 등록 후 일자/시간 등록 화면으로 이동합니다.</em>
    </div>
    ...
    <form:form modelAttribute="fcltyVO" name="fcltyVO" method="post" action="addFclty.do" onsubmit="return fn_addFcltyCheck(this)" enctype="multipart/form-data">
        <fieldset>
            <legend>시설예약 등록</legend>
            ...
            <table class="p-table">
                ...
                <tr>
                    <th scope="row"><form:label path="fcltyNm">시설예약명</form:label> <span class="p-form__required--icon margin_l_5">필수</span></th>
                    <td>
...
<%--                            </span>--%>
                ...
                <tr>
                    ...
                    <td>
                        <span class="p-form-radio">
                            <input type="radio" name="fcltyAmtYn" id="fcltyAmtN" class="p-form-radio__input" value="N" checked>
                            <label for="fcltyAmtN" class="p-form-radio__label">무료</label>
                        </span>
                        <span class="p-form-radio">
                            <input type="radio" name="fcltyAmtYn" id="fcltyAmtY" class="p-form-radio__input" value="Y">
                            <label for="fcltyAmtY" class="p-form-radio__label">유료</label>
                        </span>
                        <input type="text" name="fcltyAmtFmt" value="<c:if test="${fcltyVO.fcltyAmt > 0}"><c:out value="${fcltyVO.fcltyAmt}"/></c:if>" style="width:100px;" class="p-input p-input--auto text_right" data-mask="#,##0" data-mask-reverse="true" disabled/> 원
                        <input type="hidden" name="fcltyAmt" value="<c:out value="${fcltyVO.fcltyAmt}"/>" disabled/>
                        <span class="p-table__content padding_l_10" id="fcltyAmtWarning" style="display:none;">
...
<script>
    ...
    function fn_addFcltyCheck(form){
        ...
        if (form.telNoFmt.value) {
            if(!regexTel1.test(form.telNoFmt.value) && !regexTel2.test(form.telNoFmt.value)) {
                alert("연락처는 043-123-1234 형식으로 입력해주세요. 휴대폰번호는 추후 문자 발송(발신자 번호로 사용)이 제한될 수 있습니다.");
                form.telNoFmt.focus();
                return false;
            }
        }
