...
<div class="p-wrap">
	<div class="col-15">
		<h1 class="subHeader">설문조사 &gt; 수정 </h1>

		<form:form modelAttribute="qestnar" name="qestnar" action="updateMngQestnar.do?key=${key}&siteId=${searchVO.siteId}&amp;${searchVO.params}" onsubmit="return validateQestnar(this)">
			...
			<table class="p-table">
				...
				<tr>
					...
					<td><form:input class="p-input p-input--auto" path="qestnarSj" size="40"/> <form:errors path="qestnarSj"/></td>
				</tr>
				<tr>
					<th><form:label path="qestnarDc">설문조사 설명</form:label></th>
					<td><form:textarea class="p-input p-input--auto" path="qestnarDc" title="설문조사 설명" cols="100" rows="5"/></td>
				</tr>
				<tr>
					...
					<td>
						<div class="p-date-group">
							<div class="p-form-group p-date" data-date="datepicker">
								<form:input path="bgnde" style="width:95px;" placeholder="일자선택" class="p-input" maxlength="10" value="${qestnar.bgnde}"/>
				...
				<tr>
					...
					<td>
						<div class="p-date-group">
							<div class="p-form-group p-date" data-date="datepicker">
								<form:input path="endde" style="width:95px;" placeholder="일자선택" class="p-input" maxlength="10" value="${qestnar.endde}"/>
								<div class="p-input__split"><button type="button" class="p-input__item  p-date__icon">달력 열기</button></div> &nbsp;
								<span>
				...
				<tr>
					...
					<td><form:radiobutton path="useAt" value="Y"/>Y
						<form:radiobutton path="useAt" value="N"/>N
					</td>
				</tr>
				</tbody>
			</table>
			<div class="row margin_t_20">
				...
				<div class="col-12 right">
					<span class="button blue"><input type="submit" value="수정"class="p-button write" /></span>
					<a href="./selectQestnarMngList.do?lkey=${key}&amp;siteId=${searchVO.siteId}&amp;${searchVO.params}" class="p-button write"><span>목록</span></a>
				</div>
			</div>
		</form:form>
