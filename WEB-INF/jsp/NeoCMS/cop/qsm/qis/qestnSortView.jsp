...
<table class="p-table">
	<tr><td>
		...
		<form:form modelAttribute="qestnarQestn" name="qestnarQestn" action="updateQestnMngSort.do?key=${key}&siteId=${searchVO.siteId}&amp;${searchVO.params}"  onsubmit="return fn_updateSort(this)">
			...
			<select id="sort"  style="height:260px; width:100%; border:solid 1px #528ED8" size="16" class="p-input p-input--auto">
				<c:forEach var="result" items="${resultList}" varStatus="status">
					<option value="${result.qestnarQestnNo}">${result.qestn}</option>
				</c:forEach>
			</select>
